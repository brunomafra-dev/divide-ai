      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#5BC5A7]"
          />
        </div>
        ...
        <button
          onClick={handleCreateGroup}
          disabled={loading}
          className="w-full py-4 bg-[#5BC5A7] text-white rounded-xl font-medium hover:bg-[#4AB396] shadow-sm"
        >
